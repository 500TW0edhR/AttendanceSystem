    ...
    <div className="admin-view">
      ...
      <aside className="sidebar" style={{ display: 'flex', flexDirection: 'column' }}>
        ...
        <nav id="admin-nav" style={{ padding: '0 10px', flex: 1 }}>
          <p className={activeSec === 'sec-settings' ? 'active' : ''} onClick={() => setActiveSec('sec-settings')} style={{ borderBottom: '1px solid rgba(255,255,255,0.1)', marginBottom: '10px', paddingBottom: '10px' }}><span style={{ display: 'flex', alignItems: 'center', gap: '15px' }}><span style={{ width: '26px', height: '26px', background: '#64748b', borderRadius: '4px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '14px' }}>⚙️</span>システム設定</span></p>
